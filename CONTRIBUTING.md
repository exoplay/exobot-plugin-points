Contributing to exobot-plugin-points
======================

So you want to contribute to exobot-plugin-points? Fantastic! Here's a brief overview on
how best to do so.
...
[create an issue](https://github.com/exoplay/exobot-plugin-points/issues) before putting
...
1. [Fork the repository](https://github.com/exoplay/exobot-plugin-points/fork_select) to
  your Github account.
...
exobot-plugin-points is MIT licensed. See details in the LICENSE file. This is a very permissive
